...
**آخرین به‌روزرسانی:** ۲۷ فوریه ۲۰۲۶  
**تعداد پروکسی‌های منحصربه‌فرد:** حدود ۲۱٬۷۰۰–۲۲٬۰۰۰ (پس از حذف تکراری و پاکسازی)  
**پروتکل‌های اصلی:** VLESS (حدود ۶۸٪)، Shadowsocks، Trojan، Hysteria2 (بیش از ۲۰۰ کانفیگ)، VMess  
**فرکانس به‌روزرسانی:** هر ۳ ساعت (با GitHub Actions)
...
- آی‌پی‌های سیاه‌لیست شده (FireHOL Level 2 + bogons) حذف می‌شوند
